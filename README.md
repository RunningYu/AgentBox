...
下面的截图位置已经预留。你只需要将截图放到对应的 `docs/screenshots/` 路径，并取消对应图片语句的注释即可。
...
截图文件：`docs/screenshots/02-agent-center.png`
...
本项目许可证信息待补充。开源发布前，请根据你的实际授权方式添加 `LICENSE` 文件，并在此处更新许可证名称。
